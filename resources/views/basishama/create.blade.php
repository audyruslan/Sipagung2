...
@section('title', 'Tambah Basis Pengetahuan Hama - Sipagung')
@section('content')
            ...
            <div class="col-12 col-md-6 order-md-2 order-first">
                <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Basis Pengetahuan Hama</li>
                    </ol>
                </nav>
            </div>
        </div>
    ...
    <section class="section">
        <div class="row">
            <div class="card">
                <div class="card-body">
                    <div class="col-md-6">
                        <form method="post" action="/basishama">
                            @csrf
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('mb') is-invalid @enderror" name="mb" id="mb" placeholder="Masukkan MB" value="{{ old('mb') }}">
                                @error('mb')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('md') is-invalid @enderror" name="md" id="md" placeholder="Masukkan MD" value="{{ old('md') }}">
                                @error('md')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
